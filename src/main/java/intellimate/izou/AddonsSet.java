 ...
 * @version 1.0
 */
public class AddonsSet extends ArrayList<Identifiable> {
    /**
     ...
     *
     * @param identifiable element to be appended to this list
     * @return <tt>true</tt> (as specified by {@link Collection#add})
     */
    @Override
    public boolean add(Identifiable identifiable) {
        return super.add(identifiable);
    }
    ...
    @Override
    public boolean removeIf(Predicate<? super Identifiable> filter) {
        return super.removeIf(filter);
    }

    @Override
    public void sort(Comparator<? super Identifiable> c) {
        super.sort(c);
    }

    @Override
    public void replaceAll(UnaryOperator<Identifiable> operator) {
